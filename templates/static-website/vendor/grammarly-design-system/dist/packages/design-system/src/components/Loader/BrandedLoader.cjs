...
;/* empty css                    */
const sh_loader$1 = require("./sh_loader.mp4.cjs");
const sh_loader = require("./sh_loader.png.cjs");
const BrandedLoader = ({
  size = "medium",
  variant = "default",
  className,
  ...
  const { theme, mode } = ThemeProvider.useTheme();
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    isGenesisTheme ? isDarkMode ? /* @__PURE__ */ React.createElement(
      "img",
      {
        className: "gds-branded-loader-video",
        src: sh_loader.default,
        alt: "",
        "aria-hidden": "true"
      }
      ...
      "video",
      {
        ...
        playsInline: true,
        "aria-hidden": "true",
        poster: sh_loader.default,
        src: sh_loader$1.default
      }
    ) : /* @__PURE__ */ React.createElement(
      "svg",
      {
