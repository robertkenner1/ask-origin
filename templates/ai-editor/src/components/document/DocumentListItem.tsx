  ...
  if (isSelectionMode) {
    return (
      <div
        ...
        className={`group block cursor-pointer rounded-xl border border-transparent px-4 py-4 transition-all duration-100 ease-in-out hover:border-gray-200 hover:bg-white hover:shadow-[0_1px_2px_rgba(0,0,0,0.05)]`}
      >
        <div className="flex items-start justify-between">
          <div className="flex items-start">
            ...
            <div className="flex flex-col">
              <p
                className={`max-w-md truncate text-base font-medium text-blue-600 transition-colors group-hover:text-blue-700`}
              >
      ...
      <div className="px-4 py-4">
        <div className="max-w flex flex-grow items-start justify-between">
          <div className="flex flex-grow flex-col">
            <p
              className={`flex-grow text-base font-medium text-gray-700 transition-colors group-hover:text-blue-700 hover:text-blue-600`}
            >
              {document.title || "Untitled Document"}
            </p>
            <div className="mt-1 flex items-center gap-2">
