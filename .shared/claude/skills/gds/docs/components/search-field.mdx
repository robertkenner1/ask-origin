...
import { Button, SearchField } from "@grammarly/design-system";

# Search Field

<span>A Search Field refines a list of options based on a matching word or phrase.</span>

<ComponentStatusRow name="Search Field" />
<Hero
  path={useBaseUrl("/img/components/search_field_hero.png")}
  altText="A Search Field provide a way for a user to search images within a skill for Unsplash."
/>
<p class="caption">A user can search for images on Unsplash in a Card.</p>
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/components/search_field_anatomy.svg")}
    alt="Anatomy diagram of a Search Field"
  />
</div>
<ol className="diagram-legend small">
  <li>Label (optional)</li>
  <li>Search icon</li>
  <li>Placeholder text (optional unless the label is hidden)</li>
  <li>Input text</li>
  <li>Clear Icon Button</li>
</ol>
...
| Key              | Expected result                                                                                                                                                                                                                                 |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <kbd>Tab</kbd>   | Focuses the Search Field input.<br></br><br></br>If the focus is already in the input and a value is present, moves focus to the **Clear** Icon Button at the end of the input. If there is no Icon Button, moves focus to next focusable item. |
| <kbd>Enter</kbd> | If focus is on the **Clear** Icon Button, clears the value and moves focus back to the input. If the focus is on the input, activates the `onSubmit` callback.                                                                                  |
| <kbd>Space</kbd> | If focus is on the **Clear** Icon Button, clears the value and moves focus back to the input.                                                                                                                                                   |
| <kbd>Esc</kbd>   | Clears the input of any search value.                                                                                                                                                                                                           |
...
<RecommendationsWithCode
  ...
  recommendations={[
    {
      code: `<SearchField label="Search Unsplash. Press Enter to search." placeholder="Example: Frogs"/>`,
      caption: "Use “Example:” to offer a universal and inclusive example of an expected input.",
      type: "do",
    },
    {
      code: `<SearchField label="Search Unsplash. Press Enter to search." placeholder="Search for an image"/>`,
      caption: "Use “Search” and a meaningful description of what a user can search for.",
      type: "do",
    },
  ]}
/>
...
```tsx
import { SearchField } from "@grammarly/design-system";
```
  ...
  properties={[
    {
      ...
      description:
        "Used for the input’s label. Required for screen reader users, but visually hidden by default. Should be “Search [items]. Press Enter to search.”",
    },
    {
      propertyName: "accessibilityLabelClearButton",
      typeDefinition: "string",
      defaultValue: "Clear search",
      description: "Used to override the aria-label on the Clear Icon Button.",
    },
    {
      propertyName: "defaultValue",
      typeDefinition: "string",
      description: "Used to add prefilled text in the Search Field input.",
    },
    {
    ...
    },
    {
      ...
      defaultValue: "hidden",
      description:
        "Used to visually hide the label when another element on the page is acting as the visual label for the Search Field. The label is hidden by default in Search Field.",
    },
    {
      propertyName: "name",
      typeDefinition: "string",
      description: "Indicates the unique name for this input. Used for Form validation.",
    },
    {
      propertyName: "placeholder",
      typeDefinition: "string",
      description:
        "Adds placeholder text to the input. Should be “Search [items]” or “Example: [item]”.",
    },
    {
      propertyName: "size",
      typeDefinition:
        "'medium' | 'large' | 'xlarge'",
      defaultValue: "medium",
      description: "Controls the height of the Search Field.",
    },
    {
      propertyName: "value",
      typeDefinition: "string",
    ...
    },
    {
      ...
      description: "Event handler that is called when the input value changes.",
    },
    {
      propertyName: "onClear",
      typeDefinition: "() => void",
      description: "Event handler that is called when the Clear Icon Button is activated.",
    },
    {
      propertyName: "onFocus",
      typeDefinition: "(e: FocusEvent<Target>) => void",
      description: "Event handler that is called when the input receives focus.",
    },
    {
      propertyName: "onSubmit",
      typeDefinition: "(value: string) => void",
      description:
        "Event handler that is called when the Enter key is pressed and focus is within the input.",
    },
  ]}
/>
