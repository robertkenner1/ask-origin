...
import { Flex, Link, Text, SearchField, Heading, TextField } from "@grammarly/design-system";
...
<ComponentStatusRow name="Screen Reader Only" />
...
```tsx
import { ScreenReaderOnly } from "@grammarly/design-system";
```
  ...
  properties={[
    {
      ...
      description:
        "The content that will be visually hidden and only available to assistive technologies.",
    },
    {
      propertyName: "as",
      typeDefinition:
        '"p"| "span"| "small"| "strong"| "abbr"| "pre"| "kbd"| "label"| "legend"| "div"',
      defaultValue: "span",
