...
<Hero
  path={useBaseUrl("/img/patterns/empty_state_hero.svg")}
...
<div class="diagram p-8">
  <img src={useBaseUrl("/img/patterns/empty_state_anatomy.svg")} alt="Anatomy diagram of an empty state" />
</div>
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_usage_dashboard.svg")}
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_plagiarism_illustration.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_heading1.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_heading2.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_description1.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_description2.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_button1.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_button2.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
  **Error state:** The **Update Grammarly** Button allows a user to fix an interruption of service caused by a new version. Without this Button, they’d have to navigate to an app store or to Grammarly’s website to restart the service.
</p>
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_footer1.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
...
<div className="diagram p-8">
  <img
    src={useBaseUrl("/img/patterns/empty_state_footer2.svg")}
    alt="Headings for “Profile” and “Email preferences” have more emphasis than the text underneath them."
  />
</div>
<p class="caption">
...
<Recommendations
      recommendations={[
        {
          image: useBaseUrl("/img/patterns/empty_state_writing_do1.svg"),
          caption: "Use positive language that encourages a user. Reinforce what they have achieved or what they can do next.",
          type: "do",
        },
        {
          image: useBaseUrl("/img/patterns/empty_state_writing_dont1.svg"),
          caption: "Do not use negative statements that focus on emptiness or a lack of content.",
          type: "dont",
        },
      ]}
    />
...
<Recommendations
      recommendations={[
        {
          image: useBaseUrl("/img/patterns/empty_state_writing_do2.svg"),
          caption: "Use a heading to explain the system status in as few words as possible.",
          type: "do",
        },
        {
          image: useBaseUrl("/img/patterns/empty_state_writing_dont2.svg"),
          caption: "Do not prioritize brand moments over information. Think of this kind of playful text as tangential to a user’s primary goal.",
          type: "dont",
        },
      ]}
    />

To elaborate further, while an idiom like “You’re on point” is charming and on-brand and matches well with the illustration, this could easily be unclear to some of Grammarly’s core audience—for example, English-language learners who have not yet been exposed to this saying. By leading with “You reviewed all suggestions” in the heading, we can significantly reduce the risk of a user missing vital information about system status.
