...
import { HeadingMedium } from '@grammarly/design-system'

# Writing conventions for GDS documentation

We use these conventions to keep a consistent style across new documentation pages in GDS. These writing conventions should not be applied to the product. Instead, [reference the Content Design System in GDS](/content/).

## <HeadingMedium as="h2">General guidelines</HeadingMedium>
    ...
    - When writing documentation, follow the [GDS values](/about-gds/#gds-values) and [Company Brand Style Guide](https://coda.io/d/Grammarly-Style-Guide_dNw1zZnMEND/Grammarlys-Plans_su4UNXs7).
    ...
    - Generally, our documentation tone is less formal, so we often use “you” to refer to those implementing components and “we” to refer to the GDS team
      - Example: “If you include a visible label above the Search Field, you do not have to use placeholder text.”

## <HeadingMedium as="h2">Referring to components</HeadingMedium>
...
## <HeadingMedium as="h2">Accessibility section</HeadingMedium>
...
## <HeadingMedium as="h2">Related components section</HeadingMedium>
...
## <HeadingMedium as="h2">Vocabulary</HeadingMedium>
...
## <HeadingMedium as="h2">Punctuation</HeadingMedium>
...
## <HeadingMedium as="h2">Lists</HeadingMedium>
...
## <HeadingMedium as="h2">Image captions</HeadingMedium>
...
## <HeadingMedium as="h2">Links</HeadingMedium>
    - When linking within GDS to a page, link the name of the foundation, component, or pattern.
    - When linking to a section of a GDS page, use a descriptive statement. Example: "Learn how to write effective Tooltips."
    - When linking to an outside website, make clear where the link goes. Example: "Learn about links on MDN."
        
## <HeadingMedium as="h2">Inclusive language and the `isDisabled` attribute</HeadingMedium>
