  ...
  TokenPage({ platform, label, toc, Link }) {
    React.useEffect(() => {
      ...
      if (!toc.length) {
        toc.push(
          ...
          { value: "Border Radius", id: "border-radius", level: 2 },
          { value: "Elevation", id: "elevation", level: 2 },
          { value: "Space", id: "space", level: 2 },
          { value: "Blur Radius", id: "blur-radius", level: 2 },
          { value: "Iconography", id: "iconography", level: 2 },
          { value: "Deprecated Tokens", id: "deprecated-tokens", level: 2 },
        );
      }
    ...
    return (
      <>
        ...
        <ElevationTokens platform={platform} />
        <br />
        <br />
        <h2 id="space">Space</h2>
        <SpaceTokens platform={platform} />
        <br />
        <br />
        <h2 id="blur-radius">Blur Radius</h2>
        <BlurTokens platform={platform} />
        <br />
        <br />
        ...
        <br />
        <br />
        <h2 id="deprecated-tokens">⚠️ Deprecated Tokens</h2>
        <h3>Color</h3>
        <p style={{ paddingBottom: "12px" }}>
          Some color tokens in v6 have been deprecated to reflect changes in the design language.
          Please use the core and semantic tokens listed in the tables above in all future work.
        </p>
        <DeprecatedColorTokens platform={platform} />
      </>
    );
  },
};
