...
- type: either "continueText" (for option 1) or one of "rewriteStyle", "rewriteAngle", "rewriteTone" (for options 2-4)`,
  ...
  systemTemplate:
    "You are a helpful writing assistant that provides multiple text suggestions based on cursor position. You MUST only output valid JSON that can be parsed. Your entire response MUST be a JSON array with no other text before or after.",
};
...
- type: one of "rewriteStyle", "rewriteAngle", "rewriteTone", or "rewriteStructure"`,
  ...
  systemTemplate:
    "You are a helpful writing assistant that provides multiple rewrite options for text. You MUST only output valid JSON that can be parsed. Your entire response MUST be a JSON array with no other text before or after.",
};
