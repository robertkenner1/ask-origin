  ...
  return (
    <div className="relative">
      <button
        ...
        className={
          "flex items-center bg-transparent text-xs font-medium text-gray-600 transition-colors group-hover:text-gray-800"
        }
      >
        {currentPage.name}
      ...
      {menuOpen && (
        <div
          ref={menuRef}
          className={
            "absolute top-full left-0 z-10 mt-1 w-80 rounded-md border border-gray-200 bg-white py-1 shadow-md"
          }
        >
                    ...
                    >
                      ...
                      {pages.length > 1 && (
                        <div
                          ...
                          className={
                            "cursor-pointer p-1 text-gray-500 hover:text-red-500"
                          }
          ...
          <div
            ...
            className={
              "flex w-full cursor-pointer items-center px-3 py-2 text-left text-sm text-gray-700 transition-colors hover:bg-gray-100"
            }
            role="button"
            tabIndex={0}
