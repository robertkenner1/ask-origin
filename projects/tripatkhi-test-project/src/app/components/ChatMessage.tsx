...
export interface Message {
  ...
  thinking?: string; // Add thinking property for compatibility with Claude extended thinking
}
  ...
  return (
    <div className={`flex ${isUser ? "justify-end" : "w-full"} mb-6`}>
      {isUser ? (
        ...
        <div
          className={
            "max-w-[80%] rounded-2xl rounded-br-none bg-blue-500 px-4 py-2 break-words text-white"
          }
        >
          {message.content}
        </div>
