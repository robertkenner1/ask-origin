              ...
              <TabsContent value="chat" className={"space-y-4"}>
                <div>
                  ...
                  <textarea
                    ...
                    className={
                      "min-h-[100px] w-full rounded-md border bg-white p-2 text-base"
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    disabled={isStreaming}
                    className={
                      "w-full rounded-md border bg-white p-2 text-base"
                    }
                  >
                ...
                >
                  <label
                    className={
                      "flex items-center text-sm font-medium text-blue-800"
                    }
                  >
                    <input
                      type="checkbox"
            ...
            <div className="mb-4 rounded-lg border border-yellow-200 bg-yellow-50 p-3">
              ...
              <div className="mt-3">
                <details className="text-xs">
                  <summary
                    className={
                      "cursor-pointer font-medium text-gray-700 hover:text-gray-900"
                    }
                  >
                    Debug Information
                  </summary>
