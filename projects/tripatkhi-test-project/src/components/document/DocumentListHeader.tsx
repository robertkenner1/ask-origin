      ...
      <div className="mx-auto flex max-w-4xl items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <Link
            ...
            className={
              "inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
            }
          >
