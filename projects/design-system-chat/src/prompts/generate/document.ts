...
{{sections}}{{/if}}`,
  ...
  systemTemplate: `You are a document creation assistant specialized in creating structured document outlines. You help users start writing by providing helpful guidance and placeholder text.`,
};
...
{{sections}}{{/if}}`,
  ...
  systemTemplate: `You are an academic writing assistant specialized in creating scholarly document outlines with proper academic structure and formatting. You help researchers and students organize their thoughts and create well-structured academic papers.`,
};
