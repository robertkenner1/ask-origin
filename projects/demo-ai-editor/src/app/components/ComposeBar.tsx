...
export function ComposeBar({
  ...
  // Access sidebar store to open orchestra pane with animation
  const animateOpenSidebar = useSidebarStore(
    (state) => state.animateOpenSidebar,
  );
  ...
  const handleAskSubmit = async (e: React.FormEvent) => {
    ...
    // Open the orchestra pane with smooth animation
    await animateOpenSidebar(0);
